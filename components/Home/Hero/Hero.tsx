...
const downloadCV = () => {
  const cvUrl = "/CV.pdf"; // Ensure the CV file is in the public folder
  const link = document.createElement("a");
  link.href = cvUrl;
  link.download = "My_CV.pdf"; // The file will be saved with this name
...
const Hero = () => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 ">
    ...
    <div>
      ...
      {/*Title */}
      <h1 data-aos="fade-right" data-aos-delay="100" className="text-bg text-3xl lg:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-
